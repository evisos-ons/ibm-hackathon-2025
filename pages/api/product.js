  ...
  try {
    ...
    const productInfo = {
      ...
      product: {
        ...
        nutrients: {
          "Energy (kcal)":
            (product.nutriments["energy-kcal_100g"] || 0) * (weightNum / 100),
          "Proteins (g)":
            (product.nutriments.proteins_100g || 0) * (weightNum / 100),
          "Carbohydrates (g)":
            (product.nutriments.carbohydrates_100g || 0) * (weightNum / 100),
          "Sugars (g)":
            (product.nutriments.sugars_100g || 0) * (weightNum / 100),
          "Fat (g)": (product.nutriments.fat_100g || 0) * (weightNum / 100),
          "Saturated Fat (g)":
            (product.nutriments["saturated-fat_100g"] || 0) * (weightNum / 100),
        ...
        healthInfo: {
          ...
          isVegetarian:
            product.ingredients_analysis_tags?.includes("en:vegan") || false,
